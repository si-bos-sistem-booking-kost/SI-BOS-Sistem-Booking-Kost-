...
require('C:\xampp\htdocs\SI-BOS\config\fpdf\fpdf.php');
...
//Colored table
    function FancyTable() {
        require_once "C:/xampp/htdocs/SI-BOS/config/koneksi.php";
        require_once 'C:/xampp/htdocs/SI-BOS/config/fungsi_indotgl.php';
        ...
        $this->Ln();
        $this->SetX(45);
        $title3 = 'Rajadesa - OK - Punya - Semarang';
        $this->Write(7, $title3);
        $this->Ln();
        $this->SetX(45);
        $title4 = 'SI-BOS';
        $this->Write(7, $title4);
        $logo = "C:/xampp/htdocs/SI-BOS/images/logo.jpg";
        ...
        $this->Ln(12);
        $this->SetX(138);
        $this->Write(7, 'Semarang, '.  tgl_indo(date('Y-m-d')));
        $this->Ln(4);
        $this->SetX(150);
