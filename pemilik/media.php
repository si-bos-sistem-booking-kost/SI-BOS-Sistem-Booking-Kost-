...
if (!isset($_SESSION['pemilik'])) {
 ...
 <center><br><br><br><br><br><br>Maaf, untuk masuk <b>Halaman Owner</b><br></center>
  <center>anda harus <b>Login</b> dahulu!<br><br>
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <meta http-equiv="content-type" content="text/html;charset=UTF-8">
            ...
            <?php
            if (in_array($_GET['page'], array('maps_kost'))) {
        ...
        if (in_array($_GET['page'], array('maps_kost'))) {
            ...
            <div class="sidebar">
                ...
                <?php
                $konfirmasi = mysql_fetch_array(mysql_query('
                    ...
                    WHERE pembayaran.konfirmasi= 0
                        AND kost.pemilik_id = "'.$_SESSION['pemilik']['id'].'"'));
                ?>
                <div class="menu">
                ...
                <div class="main-wrap">
                    <div class="header clear">
                        <ul class="links clear">
                            <li>:::: <strong>Selamat Datang <?php echo $_SESSION['pemilik']['nama']; ?></strong>&nbsp;::::&nbsp;</li>
                                    ...
                                    <td width="95%">
                                        ...
                                        if ($_GET[page] == "home" || $_GET[page] == "") {
                                            echo "<h2>Selamat Datang</h2>
                                                <p>Hai <b>".$_SESSION['pemilik']['nama']."</b>, selamat datang di halaman Owner.<br> Silahkan klik menu pilihan yang berada 
                                                di sebelah kiri untuk mengelola kost anda. </p>
                                                <p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
                                                <p align=right>Login : ".$_SESSION['pemilik']['login_time']."</p>";
                                        } else {
                                            if(isset($_GET['p']) && !empty($_GET['p'])){
                                                $_SESSION['pemilik']['pagination'][$_GET['page']] = $_GET['p'];
                                            }else{
                                                $_SESSION['pemilik']['pagination'][$_GET['page']] = 1;
                                            }
